...
class MobileController extends Controller {
    ...
    public function _initialize() {
        //微信浏览器
        $this->appid = 'wx6a5ca61373bac69a';
        $this->appsecret = '473585551f8fdd6df915ace4b5cdccc7';
        /*if(!$_SESSION['openid']){
            //去授权获取openid
        ...
        $_SESSION['openid'] = 'oUBPqjhOAJqyCnvf5n4WOL4JfTyw';

        /**卡券包菜单分类 s**/
        $my_menu = C('MY_MENU');
        if( CONTROLLER_NAME == 'Coinpurse' && array_key_exists( ACTION_NAME, $my_menu )){
            $coinpures_menu['title'] = $my_menu[ACTION_NAME];
            $coinpures_menu['action'] = ACTION_NAME;
            $this->assign('coin_menu', $coinpures_menu);
        }
    }
